...
const list = [
  ...
  },
  {
    ...
    icon: (
      <TouchableOpacity>
        <VectorIcon type="FontAwesome5" size={15} name="book" />
      </TouchableOpacity>
    ),
    content:
  ...
  },
  {
    ...
    icon: (
      <TouchableOpacity>
        <VectorIcon type="FontAwesome5" size={15} name="language" />
      </TouchableOpacity>
    ),
      ...
      <View>
        {list.map((item, i) => (
          <View key={i}>
            ...
            {active === i && (
              <SelectedTransition running={active === i}>
                <InfoCard
                  onPress={handleReset}
                  title={item.title}
                  icon={item.icon}
